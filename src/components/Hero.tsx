  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] -right-[10%] w-[400px] md:w-[700px] h-[400px] md:h-[700px] bg-secondary/15 blur-[100px] md:blur-[120px] liquid-blob" style={{ animationDelay: '-6s' }}></div>
      </div>
      ...
      <div className="max-w-container-max mx-auto px-gutter grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        <div className="lg:col-span-7 flex flex-col gap-8 lg:gap-10 scroll-reveal" id="hero-content">
          <div className="technical-badge self-start">
            Tecnología Duratec
          </div>
          <h1 className="font-display text-4xl md:text-5xl lg:text-display-lg text-primary leading-[1.15] tracking-tight">
            ...
            <span className="text-deep-navy"><u>definitiva</u></span> con goma líquida de alta resistencia
          </h1>
<p className="font-body text-body-md md:text-body-lg text-on-surface-variant max-w-2xl leading-relaxed">
            Solución profesional para filtraciones en losas, techos, paredes y superficies difíciles.
          Membrana elástica que sella de raíz y resiste sol, lluvia y movimiento estructural.
          </p>
          ...
          <div className="flex flex-wrap gap-8 items-center">
            <div className="flex items-center gap-3 bg-white px-5 py-3 rounded-md industrial-border">
              ...
              <span className="font-tech text-label-tech text-on-surface">30 MPa Resistencia</span>
            </div>
            <div className="flex items-center gap-3 bg-white px-5 py-3 rounded-md industrial-border">
              <ThermostatIcon className="text-primary scale-110" />
              <span className="font-tech text-label-tech text-on-surface">-30% Reducción Térmica</span>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-6 pt-6">
            <a href="https://wa.me/595982518467" className="bg-whatsapp text-on-whatsapp px-12 py-5 rounded-md font-display text-button-text hover:bg-whatsapp/90 transition-all flex items-center justify-center gap-3 group shadow-md">
        ...
        <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
          <div className="relative w-full max-w-lg mb-12 lg:mb-0">
            ...
            <div className="absolute bottom-0 lg:-bottom-10 lg:-left-16 glass-card p-8 rounded-lg z-20 max-w-[260px] shadow-2xl">
              <p className="font-tech text-[10px] text-primary mb-2 uppercase tracking-widest">Durabilidad Industrial</p>
              <p className="font-display text-5xl text-on-surface mb-2">10 Años</p>
              <p className="font-body text-body-md text-on-surface-variant leading-tight">Protección Estructural Total Garantizada</p>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 opacity-30">
        <span className="text-[10px] uppercase tracking-[0.2em] font-tech text-on-surface">Precision Focus</span>
