  ...
  return (
    <section className="bg-industrial-dark py-10 md:py-section-padding">
      <div className="container-section">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px mt-8 md:mt-[50px] relative">
          <div className="bg-[linear-gradient(135deg,#1a1008_0%,#2a1f0a_100%)] border border-[#2a2000] min-h-[200px] md:min-h-[280px] flex items-end p-6 relative overflow-hidden">
          ...
          <div className="bg-[linear-gradient(135deg,#0a1a10_0%,#0f2a1a_100%)] border border-[#002a10] min-h-[200px] md:min-h-[280px] flex items-end p-6 relative overflow-hidden">
            <div className="absolute top-6 left-6 right-6 z-[2]">
          ...
          <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-accent text-on-primary font-display text-sm font-black uppercase px-4 py-2 z-10 whitespace-nowrap">
