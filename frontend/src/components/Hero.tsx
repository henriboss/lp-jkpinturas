...
<p className="font-body text-body-md md:text-body-lg text-on-surface-variant max-w-2xl leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-6">
            <button className="bg-secondary text-white px-12 py-5 rounded-md font-display text-button-text hover:bg-secondary/90 transition-all flex items-center justify-center gap-3 group shadow-md">
